...
/**
 * get_main_prgm_hdr_form_main_linker — Get a pointer to the ELF header of the main program.
 *
 ...
 */
static inline const ElfW(Ehdr) *get_main_prgm_hdr_form_main_linker(void)
{
